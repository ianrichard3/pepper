export const strings = {
  ...
  suggestions: {
    title: 'Suggestions',
    subtitle: 'Generate routing plans from presets or free text.',
    modes: {
      presets: 'Presets',
      intent: 'Free text',
    },
    presets: {
      ...
      recordVocals: 'Record vocals',
      recordGuitar: 'Record guitar',
      reamp: 'Reamp',
      hardwareInsert: 'Hardware insert',
    },
    options: {
      showAdvanced: 'Show advanced options',
      hideAdvanced: 'Hide advanced options',
      allowUnsafe: 'Allow unsafe routes',
      maxHops: 'Max hops',
      limit: 'Plan limit',
    },
    intent: {
      label: 'Describe what you want',
      placeholder: 'Example: Route vocal mic through preamp and compressor into interface.',
      summary: 'Parsed intent',
      warnings: 'Warnings',
      fields: {
        task: 'Task',
        source: 'Source',
    ...
    plans: {
      title: 'Plans',
      subtitle: 'Review the ranked plans before previewing and applying.',
      empty: 'No valid routes found (check device hints/tags, ports metadata, or reduce constraints).',
      planLabel: (index: number) => `Plan #${index}`,
      score: (value: number) => `Score ${value}`,
      why: 'Why this plan',
      warnings: 'Warnings',
      previewed: 'Previewed',
      conflict: 'Conflict',
      applyHint: 'Apply will preview first if needed.',
    },
    steps: {
      patch: 'Patch steps',
      info: 'Manual wiring',
      patchStep: (a: number, b: number) => `Connect patch #${a} -> #${b}`,
    },
    previewTitle: 'Preview',
    cablesTitle: 'Patch cables to create',
    touchedTitle: 'Touched patch points',
    conflictsTitle: 'Conflicts',
    conflictTitle: 'Conflict detected',
    conflictMessage: 'Patch points are occupied. Refresh state or try another plan.',
    conflictItem: (index: number) => `Conflict ${index}`,
    preview: 'Preview',
    apply: 'Apply',
    ...
    debug: 'Debug',
    details: 'Details',
    previewUnknown: 'Patch cable (details unavailable)',
    copyInstructions: 'Copy instructions',
    copySuccess: 'Instructions copied.',
    copyFailed: 'Copy failed. Please try again.',
    intentError: 'I couldn\'t understand that. Try specifying source/destination and optional chain (e.g. compressor).',
    errors: {
      conflict: 'Conflict: patch points are occupied.',
      requestFailed: 'Request failed. Please try again.',
    },
    applied: 'Applied',
    alreadyApplied: 'Already applied.',
    validation: {
      presetForm: 'Choose a preset and keep limits within range.',
      intentForm: 'Describe what you want to route.',
    },
  },
}
